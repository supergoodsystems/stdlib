...
/**
* Computes the binomial coefficient of two integers with memoization.
*
* @private
...
* @param {integer} n - input value
* @param {integer} k - second input value
* @param {integer} memo - memoization storage object
* @returns {integer} function value
*
* @example
* var v = binomcoefmemo( 8, 2, {} );
* // returns 28
*
* @example
* var v = binomcoefmemo( 0, 0, {} );
* // returns 1
*
* @example
* var v = binomcoefmemo( -4, 2, {} );
* // returns 10
*
* @example
* var v = binomcoefmemo( NaN, 3, {} );
* // returns NaN
*
* @example
* var v = binomcoefmemo( 5, NaN, {} );
* // returns NaN
*
* @example
* var v = binomcoefmemo( NaN, NaN, {} );
* // returns NaN
*/
function binomcoefmemo( n, k, memo ) {
	var res;
	var sgn;
	var b;
	var c;
	...
	*/
	b = binomcoefmemo( n, k-d+1, memo );
	c = binomcoefmemo( k, k-d+1, memo );
